...
function QuestSystemNpc.RenderBoxDismiss()
	...
	RenderText3(PosX, PosY + 10, 'Attention!', 230, 3)

    SetTextColor(255, 255, 255, 255)

    RenderText3(PosX, PosY + 50, 'You are already on a quest!', 230, 3)

    RenderText3(PosX, PosY + 60, 'If you choose to continue, you will lose all progress.', 230, 3)

    RenderText3(PosX, PosY + 70, 'If you choose to continue, you will lose all progress of the quest and start from scratch!', 230, 3)
